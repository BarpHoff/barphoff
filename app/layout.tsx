...
export const metadata: Metadata = {
  ...
  creator: 'Barp.Hoff Advogados',
  publisher: 'Barp.Hoff Advogados',
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [{ url: '/assets/images/og-cover.jpg', width: 1200, height: 630, alt: 'Barp.Hoff Advogados — Especialistas em Direito da Saúde' }],
  },
  twitter: {
...
const siteSchema = {
  ...
  logo: {
    '@type': 'ImageObject',
    url: 'https://www.barphoff.com/assets/images/logo-white.png',
    width: 700,
    height: 138,
  },
...
const alexandraSchema = {
  ...
  description:
    'Advogada sócia do escritório Barp.Hoff, especialista em Direito da Saúde, com atuação em todo o território nacional na defesa de pacientes contra negativas de planos de saúde e do SUS.',
